...
public class BasicController extends ControllerConfig {
    ...
    public ResponseEntity<GeneralResponse<QualityParty,Object>> ByQuality(@PathVariable(value = "id") Long id) {
        ...
        try {
            ...
            if (qualityParties != null) {
                result = new GeneralResponse<>(qualityParties, constant.Quality_Data_Found, true, System.currentTimeMillis(), HttpStatus.OK,request.getRequestURI());
            } else {
                result = new GeneralResponse<>(null, constant.Quality_Data_Found, false, System.currentTimeMillis(), HttpStatus.OK,request.getRequestURI());
            }
    ...
    public ResponseEntity<GeneralResponse<PartyQuality,Object>> ByParty(@PathVariable(value = "id") Long partyId) {
        ...
        try {
            ...
            if (partyQualities != null) {
                result= new GeneralResponse<>(partyQualities, constant.Quality_Data_Found, true, System.currentTimeMillis(), HttpStatus.OK,request.getRequestURI());
            } else {
    ...
    public ResponseEntity<GeneralResponse<List<PartyQuality>,Object>> ByMaster(@PathVariable(value = "userHeadId") Long userHeadId) {
        ...
        try {
            ...
            if (partyQualities != null) {
                result= new GeneralResponse<>(partyQualities, constant.PartyQuality_Data_Found , true, System.currentTimeMillis(), HttpStatus.OK,request.getRequestURI());
            } else {
                result =  new GeneralResponse<>(null, constant.Quality_Data_Not_Found, false, System.currentTimeMillis(), HttpStatus.OK,request.getRequestURI());
            }
            logService.saveLog(result,request,debugAll);
    ...
    public ResponseEntity<GeneralResponse<List<GetAllBatchWithProduction>,Object>> GetBatchByMaster(@PathVariable(value = "userHeadId") Long userHeadId) {
        ...
        try {
            ...
            if (!batchDataList.isEmpty()) {
                result =  new GeneralResponse<>(batchDataList, constant.StockBatch_Found, true, System.currentTimeMillis(), HttpStatus.OK,request.getRequestURI());
            } else {
                result =  new GeneralResponse<>(null, constant.StockBatch_Found, false, System.currentTimeMillis(), HttpStatus.OK,request.getRequestURI());
            }
            logService.saveLog(result,request,debugAll);
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public ResponseEntity<GeneralResponse<List<GetShadeByPartyAndQuality>,Object>> getShadeByPartyAndQuality(@PathVariable(value = "partyId") Long partyId, @PathVariable(value = "qualityId") Long qualityId) {
        ...
        try {
            ...
            if (shadeListByPartyAndQualities != null) {
                result= new GeneralResponse<>(shadeListByPartyAndQualities, constant.StockBatch_Found_ByPartyQuality, true, System.currentTimeMillis(), HttpStatus.OK,request.getRequestURI());
            } else {
                result =  new GeneralResponse<>(null, constant.StockBatch_Not_Found_ByMaster, false, System.currentTimeMillis(), HttpStatus.OK,request.getRequestURI());
            }
            logService.saveLog(result,request,debugAll);
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public ResponseEntity<GeneralResponse<List<GetAllBatch>,Object>> getBatchListByPartyWithoutProductionPlan(@PathVariable(value = "partyId") Long partyId) {
        ...
        try {
            if (partyId != null) {
                ...
                if (stockMast != null) {
                    result =  new GeneralResponse<>(stockMast, constant.StockBatch_Found_ByParty, true, System.currentTimeMillis(), HttpStatus.OK,request.getRequestURI());
                } else {
                    result = new GeneralResponse<>(null, constant.StockBatch_Not_Found_ByParty + partyId, false, System.currentTimeMillis(), HttpStatus.OK,request.getRequestURI());
                }
        ...
        try {
            if (qualityId != null) {
                ...
                if (!stockMast.isEmpty()) {
                    ...
                    result= new GeneralResponse<>(null, constant.StockBatch_Not_Found + qualityId, false, System.currentTimeMillis(), HttpStatus.OK,request.getRequestURI());
                }
                logService.saveLog(result,request,debugAll);
            } else {
                result = new GeneralResponse<>(null, constant.Null_Record_Passed, false, System.currentTimeMillis(), HttpStatus.OK,request.getRequestURI());
