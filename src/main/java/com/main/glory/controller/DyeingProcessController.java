...
public class DyeingProcessController extends ControllerConfig{
    ...
    public ResponseEntity<GeneralResponse<Boolean,Object>> addDyeingProcess(@RequestBody DyeingProcessMast data){
        ...
        try {
            if(data == null){
                ...
                result = new GeneralResponse<>(true, constant.DyeingProcess_Added, true, System.currentTimeMillis(), HttpStatus.CREATED,data);
            }
    ...
    public ResponseEntity<GeneralResponse<Boolean,Object>> updateDyeingProcess(@RequestBody DyeingProcessMast data){
        ...
        try {
            if(data == null){
                ...
                result = new GeneralResponse<>(true, constant.DyeingProcess_Updated, true, System.currentTimeMillis(), HttpStatus.OK,data);
            }
            logService.saveLog(result,request,debugAll);
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public ResponseEntity<GeneralResponse<List<GetAllDyeingProcessList>,Object>> getAllDyeingProcess(@RequestHeader Map<String, String> headers){
        ...
        try{
            ...
            if(!list.isEmpty()){
                result = new GeneralResponse<>(list, constant.DyeingProcess_Found, true, System.currentTimeMillis(), HttpStatus.OK,request.getRequestURI());
            }
            else
            {
                result = new GeneralResponse<>(list, constant.DyeingProcess_Not_Found, false, System.currentTimeMillis(), HttpStatus.OK,request.getRequestURI());
            }
            logService.saveLog(result,request,debugAll);
        }catch (Exception e){
            e.printStackTrace();
    ...
    public ResponseEntity<GeneralResponse<DyeingProcessMast,Object>> getDyeingProcessById(@PathVariable(name = "id") Long id){
        ...
        try{
            ...
            if(data!=null){
                result = new GeneralResponse<>(data, constant.DyeingProcess_Found, true, System.currentTimeMillis(), HttpStatus.OK,request.getRequestURI());
            }
            logService.saveLog(result,request,debugAll);
        }catch (Exception e){
            e.printStackTrace();
    ...
    public ResponseEntity<GeneralResponse<Boolean,Object>> isDyeingProcessExist(@PathVariable(name = "processName")String name,@PathVariable(name = "id") Long id){
        ...
        try{
            ...
            if(data){
                result = new GeneralResponse<>(false, constant.DyeingProcess_Not_Found, false, System.currentTimeMillis(), HttpStatus.OK,request.getRequestURI());
            }
            else {
                result= new GeneralResponse<>(true, constant.DyeingProcess_Name_Exist, true, System.currentTimeMillis(), HttpStatus.OK,request.getRequestURI());
            }
            logService.saveLog(result,request,debugAll);
        }catch (Exception e){
            e.printStackTrace();
    ...
    public ResponseEntity<GeneralResponse<Boolean,Object>> deleteProcessById(@PathVariable(name = "id") Long id){
        ...
        try{
            ...
            if(flag){
                result = new GeneralResponse<>(true, constant.DyeingProcess_Deleted, true, System.currentTimeMillis(), HttpStatus.OK,request.getRequestURI());
            }
            else
