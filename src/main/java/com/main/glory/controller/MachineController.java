...
public class MachineController extends ControllerConfig {
    ...
    public ResponseEntity<GeneralResponse<Boolean,Object>> saveMachine(@RequestBody AddMachineInfo machine) throws Exception {
        ...
        try {
            ...
            result = new GeneralResponse<>(null, ConstantFile.Machine_Data_Added, true, System.currentTimeMillis(), HttpStatus.OK,machine);
    ...
    public ResponseEntity<GeneralResponse<Boolean,Object>> saveMachineRecord(@PathVariable(name="datetime") long date, @PathVariable(name="name") String name) throws Exception {
        ...
        try {
            ...
            result = new GeneralResponse<>(null, ConstantFile.Machine_Data_Added, true, System.currentTimeMillis(), HttpStatus.OK,request.getRequestURI()+"?"+request.getQueryString());
    ...
    public ResponseEntity<GeneralResponse<Boolean,Object>> saveMachineCategory(@RequestBody AddCategory machine) throws Exception {
        ...
        if(machine==null)
        {
            throw new Exception(ConstantFile.Null_Record_Passed);//result = new GeneralResponse<>(false, "machine info is null", false, System.currentTimeMillis(), HttpStatus.OK);
        }
        ...
        try {
            ...
            result = new GeneralResponse<>(null, ConstantFile.Machine_Category_Added, true, System.currentTimeMillis(), HttpStatus.OK,machine);
    ...
    public ResponseEntity<GeneralResponse<List<GetAllCategory>,Object>> getAllMachineCategory() throws Exception {
        ...
        try {
            ...
            if(x!=null) {
                result = new GeneralResponse<>(x, ConstantFile.Machine_Data_Found, true, System.currentTimeMillis(), HttpStatus.OK, request.getRequestURI()+"?"+request.getQueryString());
            }
            else
                result = new GeneralResponse<>(x, ConstantFile.Machine_Data_Not_Found, false, System.currentTimeMillis(), HttpStatus.OK, request.getRequestURI()+"?"+request.getQueryString());
            logService.saveLog(result,request,debugAll);
        }
        catch(Exception e)
        {
    ...
    public ResponseEntity<GeneralResponse<List<GetAllMachine>,Object>> getAllMachine() throws Exception {
        ...
        try {
            ...
            result = new GeneralResponse<>(machineMasts, ConstantFile.Machine_Data_Not_Found, true, System.currentTimeMillis(), HttpStatus.OK,request.getRequestURI()+"?"+request.getQueryString());
    ...
    public ResponseEntity<GeneralResponse<GetAllMachine,Object>> getMachineById(@PathVariable(name="id") Long id) throws Exception {
        ...
        try {
            ...
            if(id==null)
            {
                throw new Exception(ConstantFile.Null_Record_Passed);//result = new GeneralResponse<>(null, "Machine Data can't be null ", true, System.currentTimeMillis(), HttpStatus.OK);
            }
    ...
    public ResponseEntity<GeneralResponse<GetAllMachine,Object>> getMachineByIdWithFilter(@RequestBody GetMachineByIdWithFilter getMachine) throws Exception {
        ...
        try {
            ...
            if(machineMasts ==null)
            {
                result = new GeneralResponse<>(null, ConstantFile.Machine_Data_Not_Found, false, System.currentTimeMillis(), HttpStatus.OK,getMachine);
            }
            else
            result = new GeneralResponse<>(machineMasts, ConstantFile.Machine_Data_Found, true, System.currentTimeMillis(), HttpStatus.OK,getMachine);
    ...
    public ResponseEntity<GeneralResponse<Boolean,Object>> deleteMachineById(@PathVariable(name="id") Long id) throws Exception {
        ...
        try {
            ...
            if(flag ==true)
            result = new GeneralResponse<>(true, ConstantFile.Machine_Data_Deleted, true, System.currentTimeMillis(), HttpStatus.OK,request.getRequestURI()+"?"+request.getQueryString());
    ...
    public ResponseEntity<GeneralResponse<Boolean,Object>> updateMachineCategory(@RequestBody MachineCategory machineCategory) throws Exception {
        ...
        try {
            ...
            if(flag ==true)
                result = new GeneralResponse<>(true, ConstantFile.Machine_Data_Added, true, System.currentTimeMillis(), HttpStatus.OK,machineCategory);
            logService.saveLog(result,request,debugAll);
    ...
    public ResponseEntity<GeneralResponse<Boolean,Object>> getCategoryIsDeletable(@PathVariable(name="id")Long id) throws Exception {
        ...
        try {
            ...
            if(flag ==true)
                result = new GeneralResponse<>(true, ConstantFile.Machine_Data_Deletable, true, System.currentTimeMillis(), HttpStatus.OK,request.getRequestURI()+"?"+request.getQueryString());
            else
                result = new GeneralResponse<>(false, ConstantFile.Machine_Data_Not_Deletable, false, System.currentTimeMillis(), HttpStatus.OK,request.getRequestURI()+"?"+request.getQueryString());
            logService.saveLog(result,request,debugAll);
    ...
    public ResponseEntity<GeneralResponse<Boolean,Object>> updateMachine(@RequestBody MachineMast machineMast) throws Exception {
        ...
        try {
            ...
            if(machineMast==null)
            {
                throw new Exception(ConstantFile.Null_Record_Passed);//esult = new GeneralResponse<>(null, "Machine Data can't be null ", true, System.currentTimeMillis(), HttpStatus.OK);
            }
            flag = machineService.updateMachineMast(machineMast);
            if(flag ==true)
                result = new GeneralResponse<>(true, ConstantFile.Machine_Data_Updated, true, System.currentTimeMillis(), HttpStatus.OK,machineMast);
            logService.saveLog(result,request,debugAll);
