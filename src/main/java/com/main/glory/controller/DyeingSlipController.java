...
public class DyeingSlipController extends ControllerConfig {
    ...
    public ResponseEntity<GeneralResponse<Boolean,Object>> updateAddtionalDyeingSlip(@RequestBody AddAddtionalSlip addAdditionDyeingSlipModel){
        ...
        try {
           ...
           result = new GeneralResponse<>(true, CommonMessage.DyeingSlip_Updated, true, System.currentTimeMillis(), HttpStatus.OK,addAdditionDyeingSlipModel);
    ...
    public ResponseEntity<GeneralResponse<GetAllAdditionalDyeingSlip,Object>> getAdditionalDyeingSlipBy(@PathVariable(name = "id") Long id){
        ...
        try {
            ...
            if(data!=null)
                ...
                result = new GeneralResponse<>(data, CommonMessage.DyeingSlip_Not_Found, false, System.currentTimeMillis(), HttpStatus.OK,request.getRequestURI());
    ...
    public ResponseEntity<GeneralResponse<Boolean,Object>> deleteAdditionalDyeingSlipBy(@PathVariable(name = "id") Long id){
        ...
        try {
            ...
            if(data)
                result = new GeneralResponse<>(data, CommonMessage.DyeingSlip_Deleted, true, System.currentTimeMillis(), HttpStatus.OK,request.getRequestURI());
            else
                result = new GeneralResponse<>(data, CommonMessage.DyeingSlip_Not_Found, false, System.currentTimeMillis(), HttpStatus.OK,request.getRequestURI());
            logService.saveLog(result,request,debugAll);
    ...
    public ResponseEntity<GeneralResponse<Boolean,Object>> updateReDyeingSlip(@RequestBody AddAddtionalSlip addAdditionDyeingSlipModel) {
        ...
        try {
            if (addAdditionDyeingSlipModel == null)
                throw new Exception(CommonMessage.Null_Record_Passed);//result = new GeneralResponse<>(false, "info can't be null", false, System.currentTimeMillis(), HttpStatus.OK);
    ...
    public ResponseEntity<GeneralResponse<List<ItemListForDirectDyeing>,Object>> getItemListByShadeAndBatch(@RequestBody GetItemByShadeAndBatch record) {
        ...
        try {
            ...
            if(!list.isEmpty())
            result = new GeneralResponse<>(list, CommonMessage.SupplierRate_Found, true, System.currentTimeMillis(), HttpStatus.OK,record);
            else
            result = new GeneralResponse<>(list, CommonMessage.SupplierRate_Not_Found, true, System.currentTimeMillis(), HttpStatus.OK,record);
