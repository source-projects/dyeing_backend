...
//            //return the record only
//            calendar.add(Calendar.DATE,-1);
//            Attendance latestAttendance = attendanceDao.getLatestAttendanceRecordWithoutFilterByEmployeeId(employeeMast.getId());
//
//            if(latestAttendance!=null)
//            {
//                if(latestAttendance.getInTime()==null && latestAttendance.getOutTime()==null) {
//                    employeeWithAttendance = new EmployeeWithAttendance(employeeMast,new Attendance());
//                }
//                else if(latestAttendance.getInTime()){
//                    //if null then check as per the condition
//                    Long diff =record.getDate().getTime() - calendar.getTime().getTime();
//                    if((diff / (60 * 60 * 1000))<10)
//                    {
//                        latestAttendance.setOutTime(record.getDate());
//                        latestAttendance.setOutUrl(record.getUrl()==null?"":record.getUrl());
//                        employeeWithAttendance = new EmployeeWithAttendance(employeeMast,attendanceDao.saveAndFlush(previousAttendance));
//
//                        /*return employeeWithAttendance;*/
//
...
//            else
//            {
//                //create response for new record and saveflag false
//                employeeWithAttendance = new EmployeeWithAttendance(employeeMast, new Attendance());
//            }
//
//
