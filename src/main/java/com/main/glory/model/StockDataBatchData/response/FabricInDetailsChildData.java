...
public class FabricInDetailsChildData {
    ...
    public FabricInDetailsChildData(String batchId,String qualityName, String qualityId, Long totalPcs, Double totalMtr, Double totalWt, Double rate, Double billingValue,Party party,UserData userData,Quality quality) {
