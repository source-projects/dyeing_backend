...
public interface UserDao extends JpaRepository<UserData, Long> {
    ...
    @Query("select u from UserData u where u.createdBy=:createdBy AND u.id!=:headerId")
...
*/
    ...
    @Query("select u from UserData u where u.id=u.userHeadId AND u.isMaster=true")
