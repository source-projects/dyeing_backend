...
*/
    ...
    List<ConsolidatedBillDataForExcel> getAllConsolidateResponseByFilter(Date from, Date to, Long userHeadId, Long partyId, Long qualityNameId, Long qualityEntryId);
    ...
    List<ConsolidatedBillDataForPDF> getAllConsolidateResponseForPDFReportByFilter(Date from, Date to, Long userHeadId, Long partyId, Long qualityNameId, Long qualityEntryId);
}
